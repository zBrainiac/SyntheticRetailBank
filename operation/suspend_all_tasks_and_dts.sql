...
-- Suspend CRM_AGG_001 Dynamic Tables (7 tables: 6 CRM + 1 Account)
...
-- ============================================================
-- SUSPEND ALL TASKS (14 total across all schemas)
-- ============================================================
SELECT 'Suspending tasks...' AS status;

-- Suspend CRM_RAW_001 Tasks (5 tasks)
...
SELECT
    ...
    'All 55 dynamic tables and 14 tasks have been suspended.' AS message,
