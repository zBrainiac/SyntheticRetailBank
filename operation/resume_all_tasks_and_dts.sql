...
-- ============================================================
-- RESUME ALL DYNAMIC TABLES (55 total across all schemas)
-- ============================================================
...
-- Resume CRM_AGG_001 Dynamic Tables (7 tables: 6 CRM + 1 Account)
...
-- Resume PAY_AGG_001 Dynamic Tables (5 tables)
...
-- ============================================================
-- RESUME ALL TASKS (14 total across all schemas)
-- ============================================================
SELECT 'Resuming tasks...' AS status;

-- Resume CRM_RAW_001 Tasks (5 tasks)
...
ALTER TASK CRM_RAW_001.CRMI_TASK_LOAD_CUSTOMER_EVENTS RESUME;
ALTER TASK CRM_RAW_001.CRMI_TASK_LOAD_CUSTOMER_STATUS RESUME;
...
ALTER TASK PAY_RAW_001.ICGI_TASK_LOAD_SWIFT_MESSAGES RESUME;
...
SELECT
    ...
    'All 55 dynamic tables and 14 tasks have been resumed.' AS message,
