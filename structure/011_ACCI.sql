...
CREATE OR REPLACE TABLE ACCI_ACCOUNTS (
    ACCOUNT_ID VARCHAR(50) NOT NULL COMMENT 'Unique account identifier (CUSTOMER_ID_ACCOUNT_TYPE_XX format)',
    ...
    CUSTOMER_ID VARCHAR(20) NOT NULL COMMENT 'Reference to customer (foreign key to CRMI_RAW_001.CRMI_PARTY)',
