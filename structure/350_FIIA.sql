...
CREATE OR REPLACE DYNAMIC TABLE FIIA_AGG_DT_TRADE_SUMMARY(
    ...
    SETTLEMENT_DATE COMMENT 'Settlement date',
    CUSTOMER_ID COMMENT 'Customer identifier',
    ACCOUNT_ID COMMENT 'Investment account',
    INSTRUMENT_TYPE COMMENT 'BOND or IRS',
    INSTRUMENT_ID COMMENT 'ISIN or swap ID',
    ISSUER COMMENT 'Issuer or counterparty',
    ISSUER_TYPE COMMENT 'SOVEREIGN, CORPORATE, SUPRANATIONAL',
    CURRENCY COMMENT 'Trade currency',
    SIDE COMMENT '1=Buy/Pay, 2=Sell/Receive',
    SIDE_DESCRIPTION COMMENT 'BUY/PAY or SELL/RECEIVE',
    NOTIONAL COMMENT 'Notional amount',
    PRICE COMMENT 'Clean price or rate',
    ...
    DURATION COMMENT 'Modified duration (years)',
    DV01 COMMENT 'Dollar value of 1bp move (CHF)',
    CREDIT_RATING COMMENT 'Credit rating',
    CREDIT_SPREAD_BPS COMMENT 'Credit spread (bps)',
    MATURITY_DATE COMMENT 'Maturity date',
    DAYS_TO_MATURITY COMMENT 'Days until maturity',
    LIQUIDITY_SCORE COMMENT 'Liquidity score (1-10)',
    TRADE_VALUE_CATEGORY COMMENT 'SMALL/MEDIUM/LARGE/VERY_LARGE',
    MATURITY_BUCKET COMMENT 'SHORT/MEDIUM/LONG term',
...
CREATE OR REPLACE DYNAMIC TABLE FIIA_AGG_DT_PORTFOLIO_POSITIONS(
    ...
    TOTAL_NOTIONAL COMMENT 'Total notional amount',
    ...
    AVERAGE_DURATION COMMENT 'Weighted average duration',
...
CREATE OR REPLACE DYNAMIC TABLE FIIA_AGG_DT_DURATION_ANALYSIS(
    ...
    WEIGHTED_AVG_DURATION COMMENT 'Weighted average duration',
    TOTAL_DV01_CHF COMMENT 'Total DV01 in CHF',
    MIN_DURATION COMMENT 'Minimum duration',
    MAX_DURATION COMMENT 'Maximum duration',
    LAST_UPDATED COMMENT 'Timestamp when calculated'
