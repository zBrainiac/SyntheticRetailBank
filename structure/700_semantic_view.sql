...
create or replace semantic view AAA_DEV_SYNTHETIC_BANK_V001.REP_AGG_001.CREDIT_RISK_IRB_REPORTING
	tables (
		REPP_AGG_DT_IRB_CUSTOMER_RATINGS,
		REPP_AGG_DT_IRB_PORTFOLIO_METRICS,
		REPP_AGG_DT_IRB_RISK_TRENDS,
...
create or replace semantic view AAA_DEV_SYNTHETIC_BANK_V001.REP_AGG_001.EQUITY_TRADING_REPORTING_ANALYTICS
	tables (
		REPP_AGG_DT_EQUITY_CURRENCY_EXPOSURE,
		REPP_AGG_DT_EQUITY_POSITIONS,
		REPP_AGG_DT_EQUITY_SUMMARY,
